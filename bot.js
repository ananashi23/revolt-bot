...
(async () => {
    ...
    const browser = await chromium.launch({ 
        ...
        args: [
            ...
            '--no-sandbox', // Often required in Linux environments
    ...
    // Note: The interactive command-line interface (readline) has been removed
    // as it is not compatible with server environments like Render.
    // To control the bot, you would need to implement a web-based API or
