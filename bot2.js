// bot.js - Modified for CE Server and The Goonery
import { chromium } from 'playwright';
import readline from 'readline';

// --- Configuration ---
// Added The Goonery server
const SERVER_NAMES = {
...
console.log("--- Starting Revolt Bot (CE Server and The Goonery Version) ---");
...
(async () => {
    ...
    console.log("🧠 Injecting the bot logic for CE server and The Goonery...");
    await context.addInitScript(() => {
        ...
        console.log('[Bot Script] Logic injected. Initializing queue and de-duplicator for CE server and The Goonery...');
        ...
        window.processQueue = async () => {
            ...
            try {
                ...
                if (serverId === "01JDKH82R0RHG2VF9YDWKEFHC5") {
                    // CE Server: Wait 500-650ms, then send /claim .3
                    message = '/claim .3';
                    delay = 500 + Math.random() * 150;
                    console.log(`[Bot Script] 🚀 Preparing to send message to CE server...`);
                } else if (serverId === "01JDKAFHS1W2BTPSS9YDB6WNEP") {
                    // The Goonery: Wait 250-350ms, then send .3
                    message = '.3';
                    delay = 250 + Math.random() * 100;
                    console.log(`[Bot Script] 🚀 Preparing to send message to The Goonery...`);
                } else {
                    // Default behavior (shouldn't happen with current configuration)
                    message = '/claim .3';
                    delay = 500 + Math.random() * 150;
                }
    ...
    await page.evaluate(({ token, targetServerIds, serverNames }) => {
        ...
        console.log('[Bot Script] Bot is ARMED and ready. De-duplicating listener is active for CE server and The Goonery.');
    ...
    console.log("🚀 Bot is now running for the CE server and The Goonery. Good luck!");
